            ...
            <Slide direction="down">
                <nav className={`w-full md:h-24 h-20 ${navBarColor ? "bg-white" : "bg-transparent"} lg:px-24 md:px-12 px-8 flex justify-between items-center`}>
                    ...
                    <div className="lg:flex hidden items-center gap-20">
                        ...
                        <ul className="flex items-center justify-center gap-6">
                            ...
                            <li className="text-gray-950">
                                <select className="border-none font-light text-base outline-none bg-transparent" title="Select language">
                    ...
                    <div className="lg:hidden flex gap-4 items-center">
                        ...
                        <select
                          id="language-select"
                          className="border-none outline-none font-light text-sm bg-transparent"
                          title="Select language"
                        >
                          <option value="EN" selected>EN</option>
                          <option value="ITA">ITA</option>
                          <option value="FRA">FRA</option>
                          <option value="FRA">THAI</option>
                          <option value="FRA">FIL</option>
                        </select>
